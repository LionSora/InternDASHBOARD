...
const WeeklyNewLeagues = () => {
  const barChartDataWeeklyRevenue = [
    {
      name: 'Vận động viên',
      data: [333, 200, 300, 390, 320, 350, 360, 320, 380],
      color: '#6AD2Fa',
    },
    {
      name: 'Ban huấn luyện',
      data: [200, 300, 400, 390, 320, 350, 360, 320, 380],
      color: '#4318FF',
    },
    {
      name: 'Người dùng khác',
      data: [300, 400, 500, 390, 320, 350, 360, 320, 380],
      color: '#EFF4FB',
    },
  ]
...
export default WeeklyNewLeagues
